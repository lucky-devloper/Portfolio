    ...
    return (
        <div id='home' className='w-[100%] h-fit flex justify-center items-center flex-col gap-5 py-2'>
            ...
            <div className='w-[98%] lg:hidden'>
                ...
                <span className='text-4xl text-center font-semibold flex flex-col items-center gap-3 mt-4'>
                    <p>full stack</p>
                    <p>developer based</p>
                    <p>in India</p>
                </span>
            ...
            <div className='w-[60%] hidden lg:block'>
                <h1 className='text-6xl font-bold w-[100%] text-center'><span className='text-gradient'>I'm Pritam Sharma,</span> full Stack developer based in India.</h1>
            </div>
            ...
            <div className='flex items-center justify-center flex-wrap gap-2 lg:gap-8'>
                ...
                <FaNode color='#7bb700' className='text-[30px] lg:text-[50px]' />
                <SiExpress color='#7bb700' className='text-[30px] lg:text-[40px]' />
                <DiMongodb  color='#409432' className='text-[30px] lg:text-[40px]' />
            </div>
            <div className='w-[100%] h-[50px] lg:h-[60px] flex justify-center items-center gap-5'>
                ...
                <a href="https://blush-vanda-69.tiiny.site" className='h-[100%] w-[120px] lg:w-[150px] border-2 border-white text-[13px] lg:text-[16px] font-semibold lg:hover:border-blue-600 rounded-full flex items-center justify-center'>My resume</a>
            </div>
        </div>
    )
}
