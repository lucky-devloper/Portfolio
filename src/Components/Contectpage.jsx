    ...
    return (
        <div id='contact' className='w-[100%] h-[100%] px-5 lg:px-0 lg:flex lg:flex-col lg:items-center'>
            ...
            <div className='w-[100%] lg:w-[80%] h-fit lg:flex lg:items-start lg:gap-10'>
                ...
                <div className='w-[100%] lg:w-[60%] flex flex-col gap-2 mt-4 lg:mt-0 lg:px-3'>
                    ...
                    <button className='mt-4 h-[55px] w-[160px] rounded-full bg-gradient-to-r from-pink-400 via-red-500 to-orange-400'>Submit now</button>
                </div>
            </div>
        </div>
    )
